<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TSS_ASPWebForms.Login" EnableEventValidation = "false"%>
    ...
    <form id="form1" runat="server" defaultbutton="btnClose">
        <div class="centerPage container-fluid" id="MainContainer" style="border-width:2px;border:solid;background-color:lightblue;">
            ...
            <div id="Login" class="container-fluid" style="width:100%;">
                <h1 style="margin-bottom:10px;width:100%;"><asp:Label runat="server" Text="Login as" meta:resourcekey="LoginAs"></asp:Label></h1>
                <asp:GridView ID="userlist" runat="server" AllowPaging="False" AutoGenerateColumns="False" CellPadding="10" CellSpacing="5" CssClass="gridview UserTable table table-responsive"
                    ...
                    style="margin:1vw;width:50vmin;background-color:white;margin-left:auto;margin-right:auto;margin-top:auto;margin-bottom:auto;">
                    <Columns>
